...
export const FEDERAIS_ESTEIRA2 = [
  ...
  { id:'mpf',       nome:'MPF',                     url:'https://www.mpf.mp.br/pgr/noticias-pgr/RSS', base:'https://www.mpf.mp.br' },
  { id:'cgu',       nome:'CGU',                     url:'https://www.gov.br/cgu/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/cgu' },
  { id:'tcu',       nome:'TCU',                     url:'https://portal.tcu.gov.br/imprensa/noticias/rss.xml', base:'https://portal.tcu.gov.br' },
  { id:'inss',      nome:'INSS',                    url:'https://www.gov.br/inss/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/inss' },
  { id:'anvisa',    nome:'Anvisa',                  url:'https://www.gov.br/anvisa/pt-br/assuntos/noticias-anvisa/ultimas-noticias/RSS', base:'https://www.gov.br/anvisa' },
  { id:'ans',       nome:'ANS',                     url:'https://www.gov.br/ans/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/ans' },
  { id:'fiocruz',   nome:'Fiocruz',                 url:'https://portal.fiocruz.br/rss.xml', base:'https://portal.fiocruz.br' },
  { id:'ibama',     nome:'Ibama',                   url:'https://www.gov.br/ibama/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/ibama' },
  { id:'icmbio',    nome:'ICMBio',                  url:'https://www.gov.br/icmbio/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/icmbio' },
  { id:'inpe',      nome:'Inpe',                    url:'https://www.gov.br/inpe/pt-br/assuntos/ultimas-noticias/RSS', base:'https://www.gov.br/inpe' },
  { id:'mec',       nome:'Ministério da Educação',  url:'https://www.gov.br/mec/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mec' },
  { id:'trabalho',  nome:'Ministério do Trabalho',  url:'https://www.gov.br/trabalho-e-emprego/pt-br/noticias-e-conteudos/ultimas-noticias/RSS', base:'https://www.gov.br/trabalho-e-emprego' },
  { id:'dnit',      nome:'Dnit',                    url:'https://www.gov.br/dnit/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/dnit' },
  { id:'antt',      nome:'ANTT',                    url:'https://www.gov.br/antt/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/antt' },
  { id:'funai',     nome:'Funai',                   url:'https://www.gov.br/funai/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/funai' },
  { id:'ipea',      nome:'Ipea',                    url:'https://www.ipea.gov.br/portal/rss', base:'https://www.ipea.gov.br' },
  ...
  { id:'itamaraty', nome:'Itamaraty',               url:'https://www.gov.br/mre/pt-br/canais_atendimento/imprensa/notas-a-imprensa/RSS', base:'https://www.gov.br/mre' },
  { id:'bc',        nome:'Banco Central',           url:'https://www.bcb.gov.br/rss/noticias', base:'https://www.bcb.gov.br' },
  { id:'govbr',     nome:'gov.br',                  url:'https://www.gov.br/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br' },
  ...
  { id:'cnj',       nome:'CNJ',                     url:'https://www.cnj.jus.br/feed/', base:'https://www.cnj.jus.br' },
  { id:'planalto',  nome:'Planalto',                url:'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/planalto' },
  { id:'agu',       nome:'AGU',                     url:'https://www.gov.br/agu/pt-br/comunicacao/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/agu' },
  { id:'cvm',       nome:'CVM',                     url:'https://www.gov.br/cvm/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/cvm' },
  { id:'defesa',    nome:'Ministério da Defesa',    url:'https://www.gov.br/defesa/pt-br/centrais-de-conteudo/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/defesa' },
  { id:'justica',   nome:'Ministério da Justiça',   url:'https://www.gov.br/mj/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mj' },
  { id:'fazenda',   nome:'Ministério da Fazenda',   url:'https://www.gov.br/fazenda/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/fazenda' },
  { id:'saude-fed', nome:'Ministério da Saúde',     url:'https://www.gov.br/saude/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/saude' },
  { id:'stm',       nome:'STM',                     url:'https://www.stm.jus.br/informacao/agencia-de-noticias/rss', base:'https://www.stm.jus.br' },
  { id:'cnmp',      nome:'CNMP',                    url:'https://www.cnmp.mp.br/portal/todas-as-noticias/RSS', base:'https://www.cnmp.mp.br' },
  { id:'dpu',       nome:'Defensoria Pública da União', url:'https://www.dpu.def.br/noticias?format=feed&type=rss', base:'https://www.dpu.def.br' }
];
...
export const EDICOES_GERAIS = {
  br: {
    ...
    livres: [
      ...
      { id:'gov-br',      nome:'gov.br',  url:'https://www.gov.br/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/pt-br/noticias' },
      ...
      { id:'anp',         nome:'ANP',     url:'https://www.gov.br/anp/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/anp/pt-br/noticias' },
      { id:'mapa',        nome:'Ministério da Agricultura', url:'https://www.gov.br/agricultura/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/agricultura/pt-br/assuntos/noticias' },
      ...ABERTAS_EDITAVEIS.map(f => ({ id:f.id, nome:f.nome, url:f.url, base:f.base })),
      { id:'saude',       nome:'Ministério da Saúde', url:'https://www.gov.br/saude/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/saude/pt-br/assuntos/noticias' },
      { id:'pf',          nome:'Polícia Federal', url:'https://www.gov.br/pf/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/pf/pt-br/assuntos/noticias' },
      { id:'prf',         nome:'Polícia Rodoviária Federal', url:'https://www.gov.br/prf/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/prf/pt-br/noticias' },
      { id:'cgu',         nome:'CGU', url:'https://www.gov.br/cgu/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/cgu/pt-br/assuntos/noticias' },
      { id:'ibama',       nome:'Ibama', url:'https://www.gov.br/ibama/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/ibama/pt-br/assuntos/noticias' },
      { id:'icmbio',      nome:'ICMBio', url:'https://www.gov.br/icmbio/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/icmbio/pt-br/assuntos/noticias' },
      { id:'mma',         nome:'Ministério do Meio Ambiente', url:'https://www.gov.br/mma/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mma/pt-br/assuntos/noticias' },
      { id:'mec',         nome:'Ministério da Educação', url:'https://www.gov.br/mec/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mec/pt-br/assuntos/noticias' },
      { id:'mj',          nome:'Ministério da Justiça', url:'https://www.gov.br/mj/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mj/pt-br/assuntos/noticias' },
      { id:'fazenda',     nome:'Ministério da Fazenda', url:'https://www.gov.br/fazenda/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/fazenda/pt-br/assuntos/noticias' },
      { id:'mds',         nome:'Ministério do Desenvolvimento Social', url:'https://www.gov.br/mds/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mds/pt-br/noticias' },
      { id:'cidades',     nome:'Ministério das Cidades', url:'https://www.gov.br/cidades/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/cidades/pt-br/assuntos/noticias' },
      { id:'transportes', nome:'Ministério dos Transportes', url:'https://www.gov.br/transportes/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/transportes/pt-br/assuntos/noticias' },
      { id:'mme',         nome:'Ministério de Minas e Energia', url:'https://www.gov.br/mme/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mme/pt-br/assuntos/noticias' },
      ...
      { id:'inss',        nome:'INSS', url:'https://www.gov.br/inss/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/inss/pt-br/noticias' },
      { id:'anvisa',      nome:'Anvisa', url:'https://www.gov.br/anvisa/pt-br/assuntos/noticias-anvisa/ultimas-noticias/RSS', base:'https://www.gov.br/anvisa/pt-br/assuntos/noticias-anvisa' },
      { id:'funai',       nome:'Funai', url:'https://www.gov.br/funai/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/funai/pt-br/assuntos/noticias' },
      { id:'dnit',        nome:'Dnit', url:'https://www.gov.br/dnit/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/dnit/pt-br/assuntos/noticias' },
...
export const NACIONAL = [
  ...
  { id:'pf', nome:'Polícia Federal', editoria:'brasil', url:'https://www.gov.br/pf/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/pf/pt-br/assuntos/noticias' },
  { id:'cgu', nome:'CGU', editoria:'brasil', url:'https://www.gov.br/cgu/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/cgu/pt-br/assuntos/noticias' },
  { id:'ibama', nome:'Ibama', editoria:'brasil', url:'https://www.gov.br/ibama/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/ibama/pt-br/assuntos/noticias' },
  { id:'mec', nome:'Ministério da Educação', editoria:'brasil', url:'https://www.gov.br/mec/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mec/pt-br/assuntos/noticias' },
  { id:'mj', nome:'Ministério da Justiça', editoria:'brasil', url:'https://www.gov.br/mj/pt-br/assuntos/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/mj/pt-br/assuntos/noticias' },
  { id:'anvisa', nome:'Anvisa', editoria:'brasil', url:'https://www.gov.br/anvisa/pt-br/assuntos/noticias-anvisa/ultimas-noticias/RSS', base:'https://www.gov.br/anvisa/pt-br/assuntos/noticias-anvisa' },
  { id:'inss', nome:'INSS', editoria:'brasil', url:'https://www.gov.br/inss/pt-br/noticias/ultimas-noticias/RSS', base:'https://www.gov.br/inss/pt-br/noticias' },
