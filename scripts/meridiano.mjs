...
const FONTE_LIVRE = [
  ...
  { id:'camara',       nome:'Agência Câmara',  editoria:'brasil',        url:'https://www.camara.leg.br/noticias/rss/ultimas' },
  { id:'senado',       nome:'Agência Senado',  editoria:'brasil',        url:'https://www12.senado.leg.br/noticias/feed/matriasrss' },
  { id:'onu',          nome:'ONU News',        editoria:'internacional', url:'https://news.un.org/pt/feed/subscribe/pt/news/all/rss.xml' },
